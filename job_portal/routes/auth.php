...
Route::middleware('auth')->group(function () {
    ...
    Route::post('logout', [AuthenticatedSessionController::class, 'destroy'])
        ...
        //     Route::get('/admin/users/{id}/edit', [AdminController::class, 'edit'])->name('admin.edit'); // Route Edit
        //     Route::put('/admin/users/{id}', [AdminController::class, 'update'])->name('admin.update'); // Route Update
        //     Route::delete('/admin/users/{id}', [AdminController::class, 'destroy'])->name('admin.destroy');
        // });

        // Route::middleware(['auth', 'verified'])->group(function () {
        //     Route::resource('jobposts', PostJobController::class);
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Route::get('/admin/{id}', [AdminController::class, 'show'])->name('admin.show'); // Route untuk show
});